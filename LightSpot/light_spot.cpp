...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // container
        {
            ...
            lightingShader.set("light.position", camera.Position);
            lightingShader.set("light.direction", camera.Front);
            lightingShader.set("light.cutOff", glm::cos(glm::radians(12.5f)));
            lightingShader.set("light.outerCutOff", glm::cos(glm::radians(14.5f)));
            lightingShader.set("light.ambient", glm::vec3{ 0.1f, 0.1f, 0.1f });
            lightingShader.set("light.diffuse", glm::vec3{ 0.8f, 0.8f, 0.8f });
